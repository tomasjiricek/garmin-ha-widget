  ...
  "sequences": [
    {
      ...
      "timeout": 1500,  // Use >= 1000ms for better battery life
      "sequence": ["UP", "OK"],  // Shorter sequences save battery
      "action": {
  ...
  "sequences": [
    {
      ...
      "sequence": ["LIGHT", "OK"],  // Simple 2-key sequence
      "action": {
